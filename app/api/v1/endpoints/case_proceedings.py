...
from app.models.schemas import CaseProceedingsRequest, CaseProceedingsResponse, ErrorResponse
...
async def get_case_proceedings(request: CaseProceedingsRequest) -> CaseProceedingsResponse:
    """
