...
class CaseDetailsResponse(BaseModel):
    ...
    vieworder_token: Optional[str] = Field(None, description="Vieworder token for file access")
    vieworder_lookups: Optional[str] = Field(None, description="Vieworder lookups for file access")
